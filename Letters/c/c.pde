...
Boolean letter_c(float x, float y) {
    return letter_o_big(x, y) || !letter_o_big(x, y) && inRectangle(x, y, n / 2, n / 2 - 20, n, 40);
}

Boolean letter_o_big(float x, float y) {
    return inEllipse(x, y, n / 2, n / 2, n / 9, n / 6) || !inEllipse(x, y, n / 2, n / 2, n / 5, n / 4);
}
